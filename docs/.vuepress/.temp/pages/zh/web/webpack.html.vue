...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="webpack和vite" tabindex="-1"><a class="header-anchor" href="#webpack和vite" aria-hidden="true">#</a> webpack和vite</h2>
...
<p>源码模块的请求会根据304 not Modified进行协商缓存，而依赖模块则会通过Cache-Control：max-age=3253600,immutable进行强制缓存，一旦被缓存它们将不再需要再次请求。</p>
<h4 id="文件系统缓存" tabindex="-1"><a class="header-anchor" href="#文件系统缓存" aria-hidden="true">#</a> 文件系统缓存</h4>
<p>Vite会将预构建的依赖缓存到node_modules/.vite。它根据几个源来决定是否需要重新运行预构建步骤：</p>
<ul>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vite-热更新" tabindex="-1"><a class="header-anchor" href="#vite-热更新" aria-hidden="true">#</a> vite 热更新</h3>
<ol>
